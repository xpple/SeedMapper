...
public enum MapFeature {
    ...
    IGLOO("igloo", Cubiomes.Igloo(), Cubiomes.DIM_OVERWORLD(), Cubiomes.MC_1_9(), "cubiomes_viewer_icons", 20, 20) {
        ...
        @Override
        public Texture getVariantTexture(MemorySegment terrainNoise, WorldIdentifier identifier, int posX, int posZ, int biome) {
    ...
    ABANDONED_CAMP("abandoned_camp", Cubiomes.Abandoned_Camp(), Cubiomes.DIM_OVERWORLD(), Cubiomes.MC_26_3(), "feature_icons", 20, 20),
