...
public class ItemArgument implements ArgumentType<Integer> {
    ...
    public static int getItem(CommandContext<FabricClientCommandSource> context, String name) {
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
        return SharedSuggestionProvider.suggest(ITEMS.keySet(), builder);
    }
