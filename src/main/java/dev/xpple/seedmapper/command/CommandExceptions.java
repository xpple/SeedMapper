...
public final class CommandExceptions {
    ...
    public static final SimpleCommandExceptionType NO_BIOME_FOUND_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.exceptions.noBiomeFound"));
    public static final SimpleCommandExceptionType NO_STRUCTURE_FOUND_EXCEPTION = new SimpleCommandExceptionType(Component.translatable("commands.exceptions.noStructureFound"));
