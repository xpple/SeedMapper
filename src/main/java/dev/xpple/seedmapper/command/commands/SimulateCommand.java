...
public class SimulateCommand extends ClientCommand implements SharedHelpers.Exceptions {
    ...
    private static final SimpleCommandExceptionType SERVER_ALREADY_RUNNING_EXCEPTION = new SimpleCommandExceptionType(Text.of("command.simulate.serverAlreadyRunning"));
    ...
    public static int stop(CustomClientCommandSource source) {
        currentServer = null;
        currentWorld = null;
